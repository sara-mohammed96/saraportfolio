...
import WorldCloud from "./skillsCloud/WorldCloud";
          ...
          <Col xs={10} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Sarah`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Frontend Developer","backend Developer"  ]'><span className="wrap">{text}</span></span></h1>
